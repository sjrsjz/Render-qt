...
Class:RenderSystemInterface{
    ...
    Traced Public getImage(N:str)->image:={
        image:t;
        getImage_(_this, str, t);
        return(t)
    }
    Traced Public getTex(N:str)->texture:={
        texture:t;
        getTex_(_this, str, t);
        return(t)
    }
    ...
    Traced Transit "" getImage_(N:this_,N:str,image:v)->N:={return(sys.getFunction("getImage"))}
    Traced Transit "" getTex_(N:this_,N:str,texture:v)->N:={return(sys.getFunction("getTex"))}
